...
function renderInvoiceHTML({ company, customer, invoice }) {
  ...
  <div class="invoice-sheet">
    ...
    <div class="inv-totals-wrap">
      <div class="inv-totals-row strong"><span class="lbl">Total Amount:</span><span class="val">₹ ${fmtMoney(totalAmount)}</span></div>
      <div class="inv-totals-row"><span class="lbl">Total Service Charge:</span><span class="val">₹ ${fmtMoney(totalAmount)}</span></div>
      <div class="inv-totals-row"><span class="lbl">Round Off:</span><span class="val">₹ ${fmtMoney(roundOff) === "0" ? "-" : fmtMoney(roundOff)}</span></div>
